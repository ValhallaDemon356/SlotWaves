...
<body>
    ...
    {{-- Operational Movement Values Table --}}
        ...
        <tbody>
            <tr>
                ...
                @foreach ($comparison['operational_trend']['passenger'] as $pt)
                    <td style="font-weight: 600;">{{ number_format($pt['value']) }}</td>
                @endforeach
            </tr>
            <tr>
                <td style="font-weight: bold;">Pergerakan Pesawat</td>
                <td style="text-align: center; color: #059669; font-weight: bold;">Movements (Line)</td>
            ...
            <tr>
                ...
                <td style="text-align: center; color: #d97706; font-weight: bold;">{{ $comparison['cargo_unit'] }} (Line)</td>
