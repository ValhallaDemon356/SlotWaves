    ...
    <header class="w-full border-b border-slate-200/80 dark:border-slate-800/80 bg-white/90 dark:bg-navy-900/90 backdrop-blur-md sticky top-0 z-30 px-4 sm:px-8 py-3 flex items-center justify-between shadow-xs">
        ...
        <div class="flex items-center gap-2.5">
            @if (!empty($activeUpload))
                <a href="{{ route('schedule.dashboard', $activeUpload->id) }}"
                   class="text-xs font-semibold text-aviation-700 dark:text-aviation-300 hover:text-aviation-800 dark:hover:text-aviation-200 px-3 py-1.5 rounded-lg border border-aviation-300 dark:border-aviation-700 bg-aviation-50 dark:bg-aviation-950/80 hover:bg-aviation-100 transition flex items-center gap-1.5 shadow-2xs">
